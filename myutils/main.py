...
def get_image_txt(opt):
    ...
    # 根据前面可以得到xml和image,每个场景下选择20%的数据,作为验证集, 生成train和test两个文件夹
    # yolov3_get_train_test_file(opt.train_data, 0.1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', type=str, default='/coding/project/leaf_counting/data/plant', help='data dir')
